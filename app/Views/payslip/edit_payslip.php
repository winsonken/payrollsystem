...
<div class="content-wrapper">
          ...
          <div class="col-12">
            ...
            <div class="card card-primary">
              <div style="background-color: #28a745;" class="card-header">
                <h3 class="card-title">Form edit payslip</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="/payslip/update_payslip/<?= $payslip["id_gaji"] ?>" method="post">
                <?= csrf_field(); ?>
                <?php helper('form'); ?>
                  ...
                  <div class="row">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <select id="payroll" name="payroll" class="form-control <?= array_key_exists("payroll", $errors) ? 'is-invalid' : '' ?>">
                              <option selected hidden>Pilih payroll</option>
                              <?php foreach($payroll as $allPayroll) : ?>
                              <option value="<?= $allPayroll->id_payroll; ?>" <?= (set_value('payroll') ? set_value('payroll') : $payslip["payroll"]) == $allPayroll->id_payroll ? 'selected' : '' ?>><?= $allPayroll->judul_payroll; ?></option>
                              <?php endforeach; ?>
                          </select>
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <select id="nama-karyawan" name="nama-karyawan" class="form-control <?= array_key_exists("payroll", $errors) ? 'is-invalid' : '' ?>">
                                <option selected hidden value="">Pilih karyawan</option>
                                <?php foreach($karyawan as $allKaryawan) : ?>
                                <option value="<?= $allKaryawan->id_karyawan; ?>" <?= (set_value('nama-karyawan') ? set_value('nama-karyawan') : $payslip["karyawan"]) == $allKaryawan->id_karyawan ? 'selected' : '' ?>><?= $allKaryawan->nama_pertama; ?> <?= $allKaryawan->nama_tengah; ?> <?= $allKaryawan->nama_belakang; ?></option>
                                <?php endforeach; ?>
                            </select>
                            <div class="invalid-feedback">
                              <?= validation_show_error('payroll'); ?>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="number" class="form-control <?= array_key_exists("gaji-karyawan", $errors) ? 'is-invalid' : '' ?> allInput" id="gaji-karyawan" name="gaji-karyawan" placeholder="Gaji karyawan" min=0 value="<?= old('gaji-karyawan') ? old('gaji-karyawan') : $payslip["gaji_perbulan"] ?>">
                          <div class="invalid-feedback">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="number" class="form-control <?= array_key_exists("jumlah-cuti", $errors) ? 'is-invalid' : '' ?>" id="jumlah-cuti" name="jumlah-cuti" placeholder="Jumlah cuti" value="<?= old('jumlah-cuti') ? old('jumlah-cuti') : $payslip["jumlah_cuti"] ?>">
                          <div class="invalid-feedback">
                  ...
                  <div class="row">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="number" class="form-control <?= array_key_exists("tunjangan-karyawan", $errors) ? 'is-invalid' : '' ?> allInput" id="tunjangan-karyawan" name="tunjangan-karyawan" placeholder="Tunjangan" value="<?= old('tunjangan-karyawan') ? old('tunjangan-karyawan') : $payslip["tunjangan"] ?>">
                          <div class="invalid-feedback">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="number" class="form-control <?= array_key_exists("kehadiran-karyawan", $errors) ? 'is-invalid' : '' ?> allInput gaji-bersih hadir" id="kehadiran-karyawan" name="kehadiran-karyawan" placeholder="Jumlah kehadiran" min=0 value="<?= old('kehadiran-karyawan') ? old('kehadiran-karyawan') : $payslip["jumlah_kehadiran"] ?>">
                          <div class="invalid-feedback">
                  ...
                  <div class="row">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="number" class="form-control <?= array_key_exists("ot", $errors) ? 'is-invalid' : '' ?> allInput gaji-bersih ot" id="ot" name="ot" placeholder="OT" value="<?= old('ot') ? old('ot') : $ot ?>">
                          <input type="hidden" class="form-control" id="hitung-ot" name="hitung-ot" value="<?= $payslip["hitung_ot"] ?>">
                          <div class="invalid-feedback">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="number" class="form-control <?= array_key_exists("pph21", $errors) ? 'is-invalid' : '' ?> allInput gaji-bersih pph21" id="pph21" name="pph21" placeholder="Pph21" value="<?= old('pph21') ? old('pph21') : $payslip["pph21"] ?>">
                          <div class="invalid-feedback">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="number" class="form-control" id="gaji-kotor" name="gaji-kotor" placeholder="Gaji kotor" min=0 readonly value="<?= $payslip["bruto_karyawan"] ?>">
                        </div>
                      </div>
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="number" class="form-control" id="gaji-bersih" name="gaji-bersih" placeholder="Gaji bersih" readonly value="<?= $payslip["gaji_bersih_karyawan"] ?>">
                        </div>
                      </div>
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-primary" style="background-color: #28a745;">Edit payslip</button>
                </div>
              </form>
  ...
  <!-- /.content-wrapper -->
  <script>
    const hitungot = document.querySelector("#hitung-ot");
